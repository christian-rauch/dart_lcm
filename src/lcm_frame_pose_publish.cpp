...
//    const dart::SE3 rep_frame_pose = _rep.getTransformCameraToFrame(_rep.getJointIdByName(frame)+1);
//    const dart::SE3 est_frame_pose = _est.getTransformCameraToFrame(_est.getJointIdByName(frame)+1);

//    const dart::SE3 rep_frame_pose = _rep.getTransformFrameToCamera(_rep.getJointIdByName(frame)+1);
//    const dart::SE3 est_frame_pose = _est.getTransformFrameToCamera(_est.getJointIdByName(frame)+1);

//    const dart::SE3 rep_frame_pose = _rep.getTransformModelToFrame(_rep.getJointIdByName(frame)+1);
//    const dart::SE3 est_frame_pose = _est.getTransformModelToFrame(_est.getJointIdByName(frame)+1);

    const dart::SE3 rep_frame_pose = _rep.getTransformFrameToModel(_rep.getJointIdByName(frame)+1);
    const dart::SE3 est_frame_pose = _est.getTransformFrameToModel(_est.getJointIdByName(frame)+1);
